                ...
                <div className="container">
                    <div className="row d-lg-flex flex-column justify-content-lg-center">
                        ...
                        <div className="col-auto d-flex flex-column flex-grow-0 justify-content-center align-content-around align-self-center flex-wrap align-items-lg-center">
                            ...
                            <p className="text-center d-flex d-xxl-flex justify-content-center align-items-center mx-auto justify-content-md-center align-items-md-center align-items-lg-center justify-content-xxl-center align-items-xxl-center footer5">Squad</p>
                            <p class="text-center footer7">Projeto estudantil</p>
